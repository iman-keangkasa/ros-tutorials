...
// actionlib::SimpleActionClient< ActionSpec > is the 
// implementation of the Class SimpleActionClient in roscpp
typedef actionlib::SimpleActionClient<FibonacciAction> Client;

class MyNode
{
  public: 
    MyNode() : ac("fibonacci", true), nh_("~")
  {
